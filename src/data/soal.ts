...
export const soalData: Soal[] = [
  ...
  },
  {
    ...
    options: [
      { label: 'A', center: { t: 'segi8', f: false }, tl: { t: 'diamond', f: false }, tr: { t: 'circle', f: true }, bl: { t: 'square', f: false }, br: { t: 'star', f: true } },
      { label: 'B', center: { t: 'segi8', f: false }, tl: { t: 'diamond', f: false }, tr: { t: 'circle', f: true }, bl: { t: 'square', f: false }, br: { t: 'star', f: true } },
  ...
  },
  {
    ...
    options: [
      { label: 'A', center: { t: 'segi7', f: true, inT: 'star', inF: true }, tl: { t: 'segi3', f: false }, tr: { t: 'square', f: true }, bl: { t: 'segi5', f: true }, br: { t: 'segi6', f: false } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'D', center: { t: 'segi7', f: false }, tl: { t: 'square', f: true }, tr: { t: 'segi6', f: true }, bl: { t: 'segi5', f: false }, br: { t: 'segi7', f: true } },
  ...
  },
  {
    ...
    boxes: [
      { center: { t: 'circle', f: true, dots: 1 }, tl: { t: 'circle', f: true }, tr: { t: 'square', f: true }, bl: { t: 'diamond', f: false }, br: { t: 'segi8', f: false } },
